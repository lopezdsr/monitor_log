...
1. Abra [https://metrics.<span class="keyword" data-hd-keyref="DomainName">DomainName</span>](https://metrics.{DomainName}) para efetuar login na interface com o usuário do Grafana.
2. Selecione **Grafana**.
